						...
						<div class="btn-toolbar" style="margin-bottom: 9px">
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="/pagina/${item.id}/edit"><i class="icon-pencil"></i> Edit</a></li>
									<li><a href="/pagina/${item.id}/delete"><i class="icon-trash"></i> Delete</a></li>
									<c:if test="${item.status eq 'ATIVO'}">
										<li><a href="/pagina/${item.id}/status/inativo"><i class="icon-ban-circle"></i> Inactivate</a></li>
									</c:if>
									<c:if test="${item.status eq 'INATIVO'}">
										<li><a href="/pagina/${item.id}/status/inativo"><i class="icon-ban-circle"></i> Activate</a></li>
									</c:if>
								</ul>
								</div>
						</div>
