...
<my:preferences-container>
	...
	<div class="row span12">
		<div class="row">
			<div class="span12">
				<form class="form-horizontal" action="/pagina/update" method="post">
					<fieldset>
						<div class="control-group">
							<label class="control-label" for="input01">Title: </label>
							<div class="controls">
								<input type="text" name="t.titulo" style="height: 28px;" class="input-xlarge span8" id="input01" value="${item.titulo}">
								<input type="hidden" name="t.idPagina" style="height: 28px;" class="input-xlarge span8" id="input01" value="${item.idPagina}">
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea class="input-xlarge span8" rows="10" cols="200"  name="t.conteudoResumido"  id="input01">
									${item.conteudoResumido}
								</textarea>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea class="input-xlarge span8" rows="20" cols="200"  name="t.conteudo"  id="input01">
									${item.conteudo}
								</textarea>
							</div>
						</div>
